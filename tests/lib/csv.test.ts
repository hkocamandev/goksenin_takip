...
describe('toCsv (Türkçe Excel)', () => {
  const rows = [
    rec({ tarih: '2026-09-24', ders: 'Türkçe', konu: 'Sözcükte Anlam; Deyimler', soru: 25, dogru: 16, yanlis: 3, bos: 6 }),
  ...
  it('tarihe göre sıralı, ondalık virgül, negatif net, deneme adı kaçışlı', () => {
    expect(lines[1]).toBe('2026-09-20;8;Matematik;Deneme;;"Özdebir ""3""";1;0;1;0;-0,33;-33,33;demo');
  });
